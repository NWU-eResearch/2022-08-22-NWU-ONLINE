...
instructor: ["Martin Dreyer","Lactatia Motsuku"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
<p id="where">
  ...
  <a href="//carpentries.zoom.us/my/carpentriesroom1">"href="//carpentries.zoom.us/my/carpentriesroom1"</a>.  If needed, the password is **202020**.
</p>
{% endif %}
{% comment %}
DATE
